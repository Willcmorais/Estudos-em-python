...
# e utilizar o 'floor' p/ arredondar p/ baixo. 'trunc' ele ilimina da ',' para frente. 'pow' para potencia. 'sqrt' para calcular a raiz quadrada.
...
n2 = random.randint(1, 100)  # o randint me da um número aleatório entre dois números escolhidos
...
print('A raiz não arredondada é {}'.format(raiz2))
